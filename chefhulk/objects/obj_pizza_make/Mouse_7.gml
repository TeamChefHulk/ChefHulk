switch(pizza_step)
{
	...
	if (global.slider_show){ global.slider_show = false; window_set_cursor(cr_handpoint); pizza_step = 3;}
	break;
	...
	case 5: 
	if (global.slider_show){ global.slider_show = false; window_set_cursor(cr_handpoint); pizza_step = 6;}
	break;
	...
	case 8: 
	if (global.slider_show){ global.slider_show = false; window_set_cursor(cr_handpoint); 
